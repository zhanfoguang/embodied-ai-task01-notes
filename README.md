# Task01 笔记：从传感器、AGV 和扫地机器人理解具身智能

## 1. 我一开始的理解和疑问

我是零基础开始学具身智能的。刚看 Task01 时，我一开始以为重点是记住机器人发展史、分类和各种技术名词，但看了一会儿发现，真正要先抓住的是一条主线：
...
这也让我理解了为什么具身智能不是单纯的大模型问题。大模型可以承担一部分“大脑”功能，但机器人真正落地，还需要传感器、本体结构、控制系统、执行器和场景适配。展会上大量传感器厂商的存在，说明产业链往往是从关键模块成熟开始，再逐步走向系统集成。
...
我以前看过一篇关于扫地机器人路径选择的文章，里面提到一个很反直觉的结论：在大量案例中，某些情况下“乱走”反而是很有效的路径策略。现在结合 Task01 再看，这其实说明机器人控制和路径规划不一定总是越复杂越好。
...
我的理解：控制器不是一次性把系统推到目标，而是每一步都看“目标值和当前值差多少”，再根据误差调整控制量。随着当前值越来越接近目标，误差逐渐变小，控制量也会变小。
...
所以机器人不会因为奖励而“开心”，但它会在训练中更倾向于重复那些带来高奖励的动作。从外部看，这有点像人类受到正反馈后更愿意继续做某件事；但本质上，它只是策略被奖励函数优化后的行为倾向。
